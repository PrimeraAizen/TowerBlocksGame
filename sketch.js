...
function preload() {
  dotImg = loadImage('images/base.png');
  boxImg = loadImage('images/base.png');
  bkgImg = loadImage('images/back.jpg');
}

function setup() {
  const canvas = createCanvas(500, 795);
  engine = Engine.create();
  world = engine.world;
  // Creating 3 bodies that later I will add into the world before
  ground = new Ground(width / 2, height - 10, width, 20);
  box = new Box(250, 726, 84, 100);
  score = new Score(10,10, 150,30);
  block = new Block(100, 10, 85, 85);
